...
function App() {
  return (
    <main>
      <div className="p-5 my-10 md:max-w-none">
        <div className="grid grid-cols-1 gap-8 mb-12 md:grid-cols-2">
          <div className="flex flex-col gap-6 items-center md:items-start">
            <h1 className="font-bold text-[2.4rem]/10 max-w-60 text-center text-primary-dark sm:max-w-80 md:font-black md:text-start">Curadoria de arte e design digital.</h1>
            <p className="text-body text-neutral-grayish-dark text-center max-w-120">
